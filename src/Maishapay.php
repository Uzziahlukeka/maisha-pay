...
class Maishapay
{
    ...
    /**
     * Look up a transaction by the merchant reference directly from MaishaPay's
     * Transaction Lookup API.
     *
     * This hits MaishaPay's servers rather than reading the local database, so
     * the returned status reflects MaishaPay's source of truth at the moment of
     * the call. Works for any transaction type (Mobile Money, card, B2C).
     */
    public function checkTransactionStatus(string $transactionReference): Response
    {
        ...
        // useRef=1 tells MaishaPay to match on the merchant reference rather
        // than its own transaction ID.
    ...
    /**
     * Look up a transaction by the MaishaPay transaction ID.
     *
     * Use this when you have the ID generated by MaishaPay (returned in the
     * initial payment response) rather than your own merchant reference.
     */
    ...
    /**
     * Verify transaction status by merchant reference.
     *
    ...
    /**
     * Make HTTP request to MaishaPay Transaction Lookup API
     */
